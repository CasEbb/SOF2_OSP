...
void CG_NewClientInfo(int clientNum)
{
    ...
    {
        trap_Cvar_Set("ui_myteam", "1");
    }
    else if (newInfo.team == TEAM_BLUE)
    {
        trap_Cvar_Set("ui_myteam", "2");
    }

    v = Info_ValueForKey(configstring, "sir");
    newInfo.specinviteRed = atoi(v);

    v = Info_ValueForKey(configstring, "sib");
    newInfo.specinviteBlue = atoi(v);
    // END
