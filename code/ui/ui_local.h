...
typedef struct
{
    ...
    int x303c4;                                // 0x303c4
    int x303c8;                                // 0x303c8
    char x303cc[MAX_CLIENTS][MAX_NAME_LENGTH]; // 0x303cc
    char x30bcc[MAX_CLIENTS][MAX_NAME_LENGTH]; // 0x30bcc
    char x313cc[MAX_CLIENTS][MAX_NAME_LENGTH]; // 0x313cc
    char x31bcc[MAX_CLIENTS][MAX_NAME_LENGTH]; // 0x31bcc
    char x323cc[MAX_CLIENTS][MAX_NAME_LENGTH]; // 0x323cc
    ...
    int x32be8;                                // 0x32be8
    int x32bec;                                // 0x32bec
    char x32bf0[MAX_CLIENTS][MAX_NAME_LENGTH]; // 0x32bf0

    int x333f0;                                // 0x333f0
    int x333f4;                                // 0x333f4
    int x333f8;                                // 0x333f8
    char x333fc[MAX_CLIENTS][MAX_NAME_LENGTH]; // 0x333fc
    int x33bfc;                                // 0x33bfc
    int x33c00;                                // 0x33c00
    int x33c04;                                // 0x33c04
    char x33c08[MAX_CLIENTS][MAX_NAME_LENGTH]; // 0x33c08

    int x34408;                                // 0x34408
    int x3440c;                                // 0x3440c
    int x34410;                                // 0x34410
    char x34414[MAX_CLIENTS][MAX_NAME_LENGTH]; // 0x34414
