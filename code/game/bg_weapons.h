...
#define WP_DELAYED_CHANGE_BIT (1 << 8)
// END
...
#define WP_FIREMODE_20MM 4
#define WP_FIREMODE_MAX 5
// END

// #define PROJECTILE_FIRE 0x0010
// #define PROJECTILE_TIMED 0x0020
// #define PROJECTILE_GRAVITY 0x0040
// #define PROJECTILE_DAMAGE_AREA 0x0080
// #define UNLOCK_MUZZLEFLASH 0x0100
// #define PROJECTILE_LIGHTGRAVITY 0x0200
#define PROJECTILE_FIRE 0x0020		   // projectile NOT bullet
#define PROJECTILE_TIMED 0x0040		   // projectile ONLY explodes after time is up
#define PROJECTILE_GRAVITY 0x0080	  // projectile obeys gravity
#define PROJECTILE_DAMAGE_AREA 0x0100  // projectile does area damage over time
#define UNLOCK_MUZZLEFLASH 0x0200	  // muzzle flash is locked to muzzle bolt by default
#define PROJECTILE_LIGHTGRAVITY 0x0400 // projectile has light gravity
#define PROJECTILE_OSP 0x0800
// END
...
qboolean BG_ParseInviewFile(qboolean pickupsDisabled, qboolean arg1, char *weaponsFile);
// END
