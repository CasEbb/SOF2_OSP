...
void SetTeam(gentity_t *ent, char *s, const char *identity, qboolean arg3);
// END
...
// OSP
void real_SendServerCommand(int clientNum, const char *text);
// END
