...
enum
{
    ...
    CS_READY = CS_HUDICONS + MAX_HUDICONS,
    CS_MATCH_PHASE,
    CS_RED_TEAM_NAME,
    CS_BLUE_TEAM_NAME,
    CS_OSP_TEAMINFO,
...
typedef struct
{
    ...
    // OSP
    int x174;             // [OSP] +0x174
    int levelTime;        // [OSP] +0x178
    int useKeyForLadders; // [OSP] +0x17c
    int ospModVersion;    // [OSP] +0x180
    // END
#if _Debug
    int isClient;
#endif
