...
gitem_t bg_itemlist[] = {
    ...
    /* QUAKED pickup_armor_big (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        ...
        {"models/pick_ups/armor_large.md3", 0, 0, 0},
    ...
    /* QUAKED pickup_armor_medium (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        "pickup_armor_medium",
        "sound/player/pickup/armour.wav",
        {"models/pick_ups/armor_medium.md3", 0, 0, 0},
    ...
    /* QUAKED pickup_armor_small (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        "pickup_armor_small",
        "sound/player/pickup/armour.wav",
        {"models/pick_ups/armor_small.md3", 0, 0, 0},
    ...
    /* QUAKED pickup_health_big (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        ...
        {"models/pick_ups/health_lrg.md3", 0, 0, 0},
    ...
    /* QUAKED pickup_health_small (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        "pickup_health_small",
        "sound/player/pickup/health.wav",
        {"models/pick_ups/health_smll.md3", 0, 0, 0},
    ...
    /* QUAKED weapon_knife (.3 .3 1) (-15 -15 -15) (15 15 15) suspended
       Don't place this*/
    {
        "weapon_knife",
        "sound/weapons/knife/ready.wav",
        {"models/weapons/knife/world/knifeworld.glm", 0, 0, 0},
       ...
       Pistol, uses 45 rounds*/
    {
        ...
        {"models/weapons/ussocom/world/ussocomworld.glm", 0, 0, 0},
        ...
        Pistol, uses 45 rounds */
    {
        "pickup_weapon_M19",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/m1911a1/world/m1911a1world.glm", 0, 0, 0},
       ...
       Pistol, uses 45 rounds */
    {
        ...
        "sound/player/pickup/weapon.wav",
        {"models/weapons/silver_talon/world/silver_talonworld.glm", 0, 0, 0},
        "gfx/menus/hud/weapon_icons/silver_talonicon",
       ...
       Sub-Machinegun, uses 9mm rounds */
    {
        ...
        "sound/player/pickup/weapon.wav",
        {"models/weapons/microuzi/world/microuziworld.glm", 0, 0, 0},
       ...
       Sub-Machinegun, uses 45 rounds */
    {
        "pickup_weapon_M3A1",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/m3a1/world/m3a1world.glm", 0, 0, 0},
       ...
       Sub-Machinegun, uses 9mm rounds */
    {
        "pickup_weapon_MP5",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/mp5/world/mp5world.glm", 0, 0, 0},
        "gfx/menus/hud/weapon_icons/mp5_icon",
       ...
       ammo ---------- amount of ammo (defaults to 10) */
    {
        ...
        "sound/player/pickup/weapon.wav",
        {"models/weapons/usas12/world/usas12world.glm", 0, 0, 0},
       ...
       Shotgun, uses 12-gauge rounds */
    {
        "pickup_weapon_M590",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/m590/world/m590world.glm", 0, 0, 0},
       ...
       Sniper Rifle, uses 7.62 rounds */
    {
        ...
        "sound/player/pickup/weapon.wav",
        {"models/weapons/msg90a1/world/msg90a1world.glm", 0, 0, 0},
       ...
       Assault Rifle, uses 5.56 rounds and 40mm grenades */
    {
        "pickup_weapon_M4",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/m4/world/m4world.glm", 0, 0, 0},
       ...
       Assault Rifle, uses 5.56 rounds */
    {
        "pickup_weapon_AK_74",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/ak74/world/ak74world.glm", 0, 0, 0},
       ...
       Assault Rifle, uses 5.56 rounds */
    {
        ...
        "sound/player/pickup/weapon.wav",
        {"models/weapons/sig551/world/sig551world.glm", 0, 0, 0},
        "gfx/menus/hud/weapon_icons/sig551_icon",
       ...
       Machinegun, uses 7.62 rounds */
    {
        "pickup_weapon_M60",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/m60/world/m60world.glm", 0, 0, 0},
       ...
       RPG, uses 40mm rounds */
    {
        "pickup_weapon_RPG_7",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/rpg7/world/rpg7world.glm", 0, 0, 0},
       ...
       Grenade Launcher, uses 40mm rounds */
    {
        "pickup_weapon_MM_1",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/mm1/world/mm1world.glm", 0, 0, 0},
       ...
       Grenade */
    {
        "pickup_weapon_M84",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/m84/world/m84world.glm", 0, 0, 0},
       ...
       Grenade */
    {
        ...
        "sound/player/pickup/weapon.wav",
        {"models/weapons/smohg92/world/smohg92world.glm", 0, 0, 0},
       ...
       Incendiary Grenade */
    {
        ...
        "sound/player/pickup/weapon.wav",
        {"models/weapons/anm14/world/anm14world.glm", 0, 0, 0},
       ...
       White Phosphorus Grenade */
    {
        "pickup_weapon_M15",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/m15/world/m15world.glm", 0, 0, 0},
    ...
    /* QUAKED pickup_ammo_45 (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        ...
        {"models/pick_ups/ammo_45_smll.md3", 0, 0, 0},
    ...
    /* QUAKED pickup_ammo_9mm (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        "pickup_ammo_9mm",
        "sound/player/pickup/ammo.wav",
        {"models/pick_ups/ammo_9mm_smll.md3", 0, 0, 0},
    ...
    /* QUAKED pickup_ammo_12gauge (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        "pickup_ammo_12gauge",
        "sound/player/pickup/ammo.wav",
        {"models/pick_ups/ammo_shotgun_smll.md3", 0, 0, 0},
    ...
    /* QUAKED pickup_ammo_762 (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        "pickup_ammo_762",
        "sound/player/pickup/ammo.wav",
        {"models/pick_ups/ammo_762_smll.md3", 0, 0, 0},
    ...
    /* QUAKED pickup_ammo_556 (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        "pickup_ammo_556",
        "sound/player/pickup/ammo.wav",
        {"models/pick_ups/ammo_556_smll.md3", 0, 0, 0},
    ...
    /* QUAKED pickup_ammo_40mm (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        "pickup_ammo_40mm",
        "sound/player/pickup/ammo.wav",
        {"models/pick_ups/ammo_40_smll.md3", 0, 0, 0},
    ...
    /* QUAKED pickup_ammo_rpg7 (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        "pickup_ammo_rpg7",
        "sound/player/pickup/ammo.wav",
        {"models/pick_ups/ammo_rpg7_smll.md3", 0, 0, 0},
    ...
    /* QUAKED pickup_backpack (0 .6 .6) (-15 -15 -15) (15 15 15) */
    {
        ...
        "pickup_backpack",
        "sound/player/pickup/health.wav",
        {"models/pick_ups/mp_universal_pickup.md3", 0, 0, 0},
        "gfx/menus/hud/weapon_icons/mp_universal_pickup",
        "",
        "a ",
        "Backpack",
        0,
    ...
    {"gametype_item_1", NULL, {0}, "", "", "the", "", 0, IT_GAMETYPE, 0, "", ""},
    {"gametype_item_2", NULL, {0}, "", "", "the", "", 0, IT_GAMETYPE, 1, "", ""},
    {"gametype_item_3", NULL, {0}, "", "", "the", "", 0, IT_GAMETYPE, 2, "", ""},
    {"gametype_item_4", NULL, {0}, "", "", "the", "", 0, IT_GAMETYPE, 3, "", ""},
    {"gametype_item_5", NULL, {0}, "", "", "the", "", 0, IT_GAMETYPE, 4, "", ""},
    ...
    // OSP
    {
        "pickup_weapon_US_SOCOM_SILENCED",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/ussocom_sil_MS/ussocom_sil_MS.glm", 0, 0, 0},
        "gfx/menus/hud/weapon_icons/ussocomsil_icon",
        "*menu/ussocomsil_mp",
        "a",
        "Silenced US SOCOM",
        10,
...

    {
        "pickup_weapon_OICW",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/oicw/oicw.glm", 0, 0, 0},
...

    {
        "pickup_weapon_MDN11",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/mdn11/world/mdn11world.glm", 0, 0, 0},
...

    {
        "pickup_weapon_F1",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/f1/world/f1world.glm", 0, 0, 0},
...

    {
        "pickup_weapon_L2A2",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/l2a2/world/l2a2world.glm", 0, 0, 0},
...

    {
        "pickup_weapon_M67",
        "sound/player/pickup/weapon.wav",
        {"models/weapons/m67/world/m67world.glm", 0, 0, 0},
...
================
*/
qboolean BG_CanItemBeGrabbed(int gametype, const entityState_t *ent, const playerState_t *ps, qboolean arg3)
{
    gitem_t *item;
    ...
    case IT_WEAPON:
        ...
        if (AMMOWRAP(*ps, weaponData[item->giTag].attack[ATTACK_NORMAL].ammoIndex) >= ammoData[weaponData[item->giTag].attack[ATTACK_NORMAL].ammoIndex].max)
        // END
        {
            if (BG_WeaponHasAlternateAmmo(item->giTag))
            {
                ...
                if (AMMOWRAP(*ps, weaponData[item->giTag].attack[ATTACK_ALTERNATE].ammoIndex) >= ammoData[weaponData[item->giTag].attack[ATTACK_ALTERNATE].ammoIndex].max)
                // END
                {
                    return qfalse;
                }
    ...
    case IT_AMMO:
        ...
        if (AMMOWRAP(*ps, item->giTag) >= ammoData[item->giTag].max)
        // END
        {
    ...
    case IT_BACKPACK:
    {
        ...
        if (!ps->stats[STAT_GOGGLES] && ps->stats[STAT_ARMOR] != MAX_HEALTH && !arg3)
        // END
        {
            return qtrue;
        }
        ...
        if (ps->pm_flags & PMF_LIMITED_INVENTORY)
        {
            ...
            // OSP
            if (arg3 && ps->stats[15] >= 0 && !(ps->stats[STAT_WEAPONS] & (1 << ps->stats[15])))
            {
                return qtrue;
            }
            // END
...
void BG_EvaluateTrajectory(const trajectory_t *tr, int atTime, vec3_t result)
{
    ...
    case TR_XXX:
    {
        ...
        VectorScale(tr->trDelta, 5.0 * deltaTime, x30);
        VectorMA(tr->trBase, deltaTime, x30, result);
        break;
    }
    // END
    case TR_SINE:
...
void BG_EvaluateTrajectoryDelta(const trajectory_t *tr, int atTime, vec3_t result)
{
    ...
    case TR_XXX:
        deltaTime = (atTime - tr->trTime) * 0.001;
        VectorScale(tr->trDelta, deltaTime * 5.0, result);
        break;
    // END
    case TR_SINE:
        deltaTime = (atTime - tr->trTime) / (float)tr->trDuration;
...
// OSP
void OSP_LogHit(ospStats_t *attackerStats, ospStats_t *targetStats, int location)
{
    ...
    if (location & HL_CHEST_RT ||
        location & HL_CHEST_LT ||
        location & HL_CHEST ||
        location & HL_BACK_RT ||
        location & HL_BACK_LT ||
        location & HL_BACK)
    ...
    if (location & HL_WAIST)
    {
        attackerStats->x44[4]++;
        targetStats->x5c[4]++;
    }

    if (location & HL_FOOT_RT ||
        location & HL_FOOT_LT ||
        location & HL_LEG_UPPER_RT ||
        location & HL_LEG_UPPER_LT ||
        location & HL_LEG_LOWER_RT ||
        location & HL_LEG_LOWER_LT)
    {
        attackerStats->x44[5]++;
        targetStats->x5c[5]++;
    }
